...
_o_: old files _"_: registers _?_: vim help
     ...
     _<Enter>_: pickers  _<Esc>_: exit
      ...
      heads = {
        ...
        { "b",       function() Snacks.picker.buffers() end },
        { "o",       function() Snacks.picker.recent() end },
        { "s",       function() Snacks.picker.grep() end },
        { "*",       function() Snacks.picker.grep_word() end },
        { '"',       function() Snacks.picker.registers() end },
        { "r",       function() Snacks.picker.resume() end },
        { ";",       function() Snacks.picker.command_history() end },
        { "?",       function() Snacks.picker.help() end },
        { "<Enter>", function() Snacks.picker() end },
        { "<Esc>",   nil,                                           { nowait = true } },
      },
    })
  end,
