return {
  ...
  opts = {
    ...
    sources = {
      default = { 'lazydev', 'lsp', 'path', 'snippets', 'buffer', 'markdown', 'dictionary' },
      cmdline = function()
      ...
      providers = {
        ...
        dictionary = {
          ...
          opts = {
            ...
            dictionary_files = {
              vim.fn.expand("~/Repos/b234r/Dotfiles/nvim/spell/en.utf-8.add"),
              vim.fn.expand("~/Repos/b234r/Dotfiles/nvim/spell/es.utf-8.add"),
            },
            documentation = {
